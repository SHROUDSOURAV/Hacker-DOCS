...
## Search Specific Payload

```bash
grep <keyword> show payloads
```
...
- Once you gain the meterpreter shell you can type the `help` command to list all the commands available for meterpreter shell.
